...
Stepper myStepperX(stepsPerRevolution, 4,5,2,3); 
...
float StepsPerMillimeterX = 20.0;
float StepsPerMillimeterY = 20.0;
...
void setup() {
  //  Setup
  Serial.begin( 115200 );
  Serial.println( "Grbl 0.8c [BenBox LaserS]" );
    
  pinMode(penLaserPin,OUTPUT);
  
  digitalWrite(penLaserPin,LOW);
  delay(200);
